...
public class StudentsManagementDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public StudentsManagementDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
