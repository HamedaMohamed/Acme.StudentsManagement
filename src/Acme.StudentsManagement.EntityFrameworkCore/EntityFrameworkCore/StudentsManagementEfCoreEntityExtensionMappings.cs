...
public static class StudentsManagementEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE StudentsManagementModuleExtensionConfigurator CLASS (in the Domain.Shared project)
