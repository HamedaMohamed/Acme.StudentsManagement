...
public class StudentsManagementDbContext :
    AbpDbContext<StudentsManagementDbContext>,
    ...
    IIdentityDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(StudentsManagementConsts.DbTablePrefix + "YourEntities", StudentsManagementConsts.DbSchema);
